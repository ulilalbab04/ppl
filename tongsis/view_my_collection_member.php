...
<?php 	
	...
	$id = $_GET['id'];
	$hasil = mysql_query("SELECT * FROM file_foto WHERE id_foto = '$id' AND id_pengguna='$cek_id_pengguna'");
	if(empty($hasil)){
		echo "My Collection photo tidak tersedia.";
	}else{
	...
	<div class="container-fluid">
		...
		<div class="col-md-6" style="padding-top: 70px;">
			...
			<div class="embed-responsive embed-responsive-4by3" style="padding-bottom: 29%;">
				<iframe class="embed-responsive-item" src="comment_box_member.php?id=<?php echo $id; ?>"></iframe>
			</div>
			<form class="form-horizontal" action="add_comment_my_collection_photo.php?id=<?php echo $id;?>" method="post">
			<div class="container-fluid">
