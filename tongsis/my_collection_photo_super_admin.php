							...
							if(empty($dataTable)){
								...
								foreach ($dataTable as $i => $data)
								{
									...
									<td>
										...
										?>
										<a href="view_my_collection_super_admin.php?id=<?php echo $id;?>">
											<img src="galeri/<?php echo $data['nama_file'];?>" alt="aba" width="250" height="210" border="0"/>
										</a>
										<br>
										<?php echo substr($data['nama_file'],0,-4);?>&nbsp
										<a href="delete_my_collection_photo.php?id=<?php echo $id;?>&page=<?php echo $page;?>&name=<?php echo $nama_foto;?>" onclick="return confirm ('Apakah anda yakin akan menghapus <?php echo $nama_foto;?>?')">
