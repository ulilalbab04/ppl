...
<?php 	
	...
	if ($act==1){
			$q_act=mysql_query("UPDATE file_pengguna SET level=3 WHERE id_pengguna='$id_pengguna'") or die ("ERROR query update user di file_pengguna".mysql_error());
		}
	else if($act==2){
...
?>		
	<script>
		document.location.href="confirm_registration.php?page=<?php echo $page;?>";
	</script>
